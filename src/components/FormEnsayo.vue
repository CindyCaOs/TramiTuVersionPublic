<template>
    <section class="main">
        <figure class="main__figure">
            ...
            <form class="form">
                <p class="form_paragraph">Para generar el documento por favor diligencia los siguientes datos</p>
                <div class="form_container">
                    <div class="form_group">
                        <select name="provincias" id="provincias" placeholder="" class="form_input" v-model="municipio" @click="cargarMunicipios()"></select>
                        <label class="form_label" for="provincias">Ciudad</label>
                ...
                <div class="form_container">
                    <div class="form_group">
                            <select name="id-document" id="name" placeholder="" v-model="tipodocumento" class="form_input">
                            <option value="Tarjeta de Identidad" class="form_input" >Tarjeta de Identidad</option>
                            <option value="Cedula de Ciudadania" class="form_input">Cedula de Ciudadania</option>
                            <option value="Cedula de Extranjeria" class="form_input">Cedula de Extranjeria</option>
                        </select> 
                ...
                <div class="form_container">
                    <div class="form_group">
                        <input type="text" id='name' placeholder="" v-model="telefono" class="form_input">
                ...
                <div class="form_container">
                    <div class="form_group">
                        <input type="text" id='name' placeholder="" v-model="correo" class="form_input">
                ...
                <div class="form_container">
                    <div class="form_group">
                        <input type="text" id='name' placeholder="" v-model="dirnotificacion" class="form_input">
...
body{
    ...
    background-image: radial-gradient(#e8f5cc .5px, transparent .5px), radial-gradient(#e8f5cc .5px, transparent .5px);
